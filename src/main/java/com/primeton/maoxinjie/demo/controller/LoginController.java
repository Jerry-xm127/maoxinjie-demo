...
public class LoginController {
	...
	public ResponseResult getUserByAccountAndPwd(@RequestParam String account, @RequestParam String pwd,HttpSession httpSession) {
		//存放返回前台信息
		...
		try {
			...
			if (null != user) {
				...
				responseResult = ResponseResult.error(ResultCodeEnum.ACCOUNT_PWD_ERROR.getCode(), ResultCodeEnum.ACCOUNT_PWD_ERROR.getMessage());
			}
		} catch (Exception e) {
